        ...
        <el-col :span="8">
          <el-form-item label="N° Muestra" prop="numMuestra">
            ...
            <el-select
              ...
              :no-data-text="placeholderNumeroMuestra"
            ...
            <el-form-item prop="refrentadoMuestraCuatro">
              <el-radio
                @click.native.prevent="
                  clickitem('refrentadoMuestraCuatro', 'SI')
                "
              ...
              <el-radio
                @click.native.prevent="
                  clickitem('refrentadoMuestraCuatro', 'NO')
                "
                v-model="form.refrentadoMuestraCuatro"
                label="NO"
                >NO</el-radio
        ...
        <el-col :span="24">
          ...
          <div class="texto-muestras">
            <el-form-item prop="perpendicularidadMuestraUno">
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraUno', 'SI')
                "
              ...
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraUno', 'NO')
                "
                v-model="form.perpendicularidadMuestraUno"
                label="NO"
                >NO</el-radio
          ...
          <div class="texto-muestras">
            <el-form-item prop="perpendicularidadMuestraDos">
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraDos', 'SI')
                "
              ...
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraDos', 'NO')
                "
                v-model="form.perpendicularidadMuestraDos"
                label="NO"
                >NO</el-radio
          ...
          <div class="texto-muestras">
            <el-form-item prop="perpendicularidadMuestraTres">
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraTres', 'SI')
                "
              ...
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraTres', 'NO')
                "
                v-model="form.perpendicularidadMuestraTres"
                label="NO"
                >NO</el-radio
          ...
          <div class="texto-muestras">
            <el-form-item prop="perpendicularidadMuestraCuatro">
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraCuatro', 'SI')
                "
              ...
              <el-radio
                @click.native.prevent="
                  clickitem('perpendicularidadMuestraCuatro', 'NO')
                "
                v-model="form.perpendicularidadMuestraCuatro"
                label="NO"
                >NO</el-radio
        ...
        <el-col :span="24">
          ...
          <div class="texto-muestras">
            <el-form-item prop="planeidadMuestraCuatro">
              <el-radio
                @click.native.prevent="
                  clickitem('planeidadMuestraCuatro', 'SI')
                "
              ...
              <el-radio
                @click.native.prevent="
                  clickitem('planeidadMuestraCuatro', 'NO')
                "
                v-model="form.planeidadMuestraCuatro"
                label="NO"
                >NO</el-radio
        ...
        <el-col :span="24">
          ...
          <div class="texto-muestras">
            <el-form-item prop="volumenMuestraUno">
              <el-input
                class="no-click"
                v-model="form.volumenMuestraUno"
              ></el-input>
            </el-form-item>
          </div>
          <div class="texto-muestras">
            <el-form-item prop="volumenMuestraDos">
              <el-input
                class="no-click"
                v-model="form.volumenMuestraDos"
              ></el-input>
            </el-form-item>
          </div>
          <div class="texto-muestras">
            <el-form-item prop="volumenMuestraTres">
              <el-input
                class="no-click"
                v-model="form.volumenMuestraTres"
              ></el-input>
            </el-form-item>
          </div>
          <div class="texto-muestras">
            <el-form-item prop="volumenMuestraCuatro">
              <el-input
                class="no-click"
                v-model="form.volumenMuestraCuatro"
              ></el-input>
            </el-form-item>
          </div>
        </el-col>
        ...
        <el-col :span="24">
          ...
          <div class="texto-muestras">
            <el-form-item prop="velocidadMuestraCuatro">
              <el-radio
                @click.native.prevent="
                  clickitem('velocidadMuestraCuatro', 'SI')
                "
              ...
              <el-radio
                @click.native.prevent="
                  clickitem('velocidadMuestraCuatro', 'NO')
                "
                v-model="form.velocidadMuestraCuatro"
                label="NO"
                >NO</el-radio
...
export default {
  ...
  methods: {
    ...
    calculaFactorCompresion(
      ...
      let result = (
        ((parseFloat(valorRecibido) - parseFloat(resistenciaUno)) /
          (parseFloat(resistenciaDos) - parseFloat(resistenciaUno))) *
          (parseFloat(factorDos) - parseFloat(factorUno)) +
        parseFloat(factorUno)
      ).toFixed(2);
      return result;
    },
    cargaDatosEnsayo() {
  ...
  watch: {
      ...
      if (this.ordenSeleccionada.length != 0) {
        ...
        var results =
          numerosDeMuestraFiltrados.length > 0
            ? numerosDeMuestraFiltrados.map((elemento) => {
        ...
        if (this.ensayoCargado) {
          ...
          var resultss =
            numsDeMuestraFiltrados.length > 0
              ? numsDeMuestraFiltrados.map((elemento) => {
                  return { value: elemento, id: elemento };
                })
              : [];
    ...
    "form.resistenciaCompresionMuestraUno": function (newVal, oldVal) {
      ...
      commaReplaced = this.form.tiempoCargaMuestraUno
        .toString()
        .replace(",", ".");
      ...
      if (
        ...
        !isNaN(this.form.resistenciaCompresionMuestraUno) &&
        this.form.resistenciaCompresionMuestraUno.toString().trim() != ""
      ) {
        this.form.velocidadEnsayoMuestraUno = (
          parseFloat(this.form.resistenciaCompresionMuestraUno) /
    ...
    "form.resistenciaCompresionMuestraTres": function (newVal, oldVal) {
      ...
      commaReplaced = this.form.tiempoCargaMuestraTres
        .toString()
        .replace(",", ".");
      ...
      if (
        ...
        !isNaN(this.form.resistenciaCompresionMuestraTres) &&
        this.form.resistenciaCompresionMuestraTres.toString().trim() != ""
      ) {
        this.form.velocidadEnsayoMuestraTres = (
          parseFloat(this.form.resistenciaCompresionMuestraTres) /
    ...
    "form.resistenciaCompresionMuestraCuatro": function (newVal, oldVal) {
      ...
      commaReplaced = this.form.tiempoCargaMuestraCuatro
        .toString()
        .replace(",", ".");
      ...
      if (
        ...
        !isNaN(this.form.resistenciaCompresionMuestraCuatro) &&
        this.form.resistenciaCompresionMuestraCuatro.toString().trim() != ""
      ) {
        this.form.velocidadEnsayoMuestraCuatro = (
          parseFloat(this.form.resistenciaCompresionMuestraCuatro) /
    ...
    "form.volumenMuestraDos": function (newVal, oldVal) {
      ...
      if (
        ...
        this.form.volumenMetroCubicoMuestraDos = (
          parseFloat(this.form.volumenMuestraDos) / 1000000000
        )
          .toFixed(12)
          .toString();
      } else {
    ...
    "form.volumenMuestraTres": function (newVal, oldVal) {
      ...
      if (
        ...
        this.form.volumenMetroCubicoMuestraTres = (
          parseFloat(this.form.volumenMuestraTres) / 1000000000
        )
          .toFixed(12)
          .toString();
      } else {
    ...
    "form.volumenMuestraCuatro": function (newVal, oldVal) {
      ...
      if (
        ...
        this.form.volumenMetroCubicoMuestraCuatro = (
          parseFloat(this.form.volumenMuestraCuatro) / 1000000000
        )
          .toFixed(12)
          .toString();
      } else {
    ...
    "form.hUnoMuestraUnoCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraUnoCorregida) &&
        this.form.hUnoMuestraUnoCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraUnoCorregida) &&
        this.form.hDosMuestraUnoCorregida.toString().trim() != "" &&
        !isNaN(this.form.areaMuestraUno) &&
        this.form.areaMuestraUno.toString().trim() != ""
      ) {
        this.form.volumenMuestraUno =
          parseFloat(this.form.areaMuestraUno) *
          ((parseFloat(this.form.hUnoMuestraUnoCorregida) +
            parseFloat(this.form.hDosMuestraUnoCorregida)) /
            2);
      } else {
        this.form.volumenMuestraUno = "---";
      }
    },
    "form.hDosMuestraUnoCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraUnoCorregida) &&
        this.form.hUnoMuestraUnoCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraUnoCorregida) &&
    ...
    "form.hUnoMuestraDosCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraDosCorregida) &&
        this.form.hUnoMuestraDosCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraDosCorregida) &&
        this.form.hDosMuestraDosCorregida.toString().trim() != "" &&
        !isNaN(this.form.areaMuestraDos) &&
        this.form.areaMuestraDos.toString().trim() != ""
      ) {
        this.form.volumenMuestraDos =
          parseFloat(this.form.areaMuestraDos) *
          ((parseFloat(this.form.hUnoMuestraDosCorregida) +
            parseFloat(this.form.hDosMuestraDosCorregida)) /
            2);
      } else {
        this.form.volumenMuestraDos = "---";
      }
    },
    "form.hDosMuestraDosCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraDosCorregida) &&
        this.form.hUnoMuestraDosCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraDosCorregida) &&
    ...
    "form.hUnoMuestraTresCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraTresCorregida) &&
        this.form.hUnoMuestraTresCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraTresCorregida) &&
        this.form.hDosMuestraTresCorregida.toString().trim() != "" &&
        !isNaN(this.form.areaMuestraTres) &&
        this.form.areaMuestraTres.toString().trim() != ""
      ) {
        this.form.volumenMuestraTres =
          parseFloat(this.form.areaMuestraTres) *
          ((parseFloat(this.form.hUnoMuestraTresCorregida) +
            parseFloat(this.form.hDosMuestraTresCorregida)) /
            2);
      } else {
        this.form.volumenMuestraTres = "---";
      }
    },
    "form.hDosMuestraTresCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraTresCorregida) &&
        this.form.hUnoMuestraTresCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraTresCorregida) &&
    ...
    "form.hUnoMuestraCuatroCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraCuatroCorregida) &&
        this.form.hUnoMuestraCuatroCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraCuatroCorregida) &&
        this.form.hDosMuestraCuatroCorregida.toString().trim() != "" &&
        !isNaN(this.form.areaMuestraCuatro) &&
        this.form.areaMuestraCuatro.toString().trim() != ""
      ) {
        this.form.volumenMuestraCuatro =
          parseFloat(this.form.areaMuestraCuatro) *
          ((parseFloat(this.form.hUnoMuestraCuatroCorregida) +
            parseFloat(this.form.hDosMuestraCuatroCorregida)) /
            2);
      } else {
        this.form.volumenMuestraCuatro = "---";
      }
    },
    "form.hDosMuestraCuatroCorregida": function (newVal, oldVal) {
      if (
        !isNaN(this.form.hUnoMuestraCuatroCorregida) &&
        this.form.hUnoMuestraCuatroCorregida.toString().trim() != "" &&
        !isNaN(this.form.hDosMuestraCuatroCorregida) &&
    ...
    "form.tiempoCargaMuestraDos": function (newVal, oldVal) {
      ...
      if (
        ...
        !isNaN(this.form.resistenciaCompresionMuestraDos) &&
        this.form.resistenciaCompresionMuestraDos.toString().trim() != ""
      ) {
        this.form.velocidadEnsayoMuestraDos = (
          parseFloat(this.form.resistenciaCompresionMuestraDos) /
